...
/**
 * Procedurally generated test specimens for the landing page's assay table.
 *
 ...
 * interpolated. Summing octaves gives an approximately 1/f spectrum, which
 * is what natural photographs have and what effectiveResolution expects a
 * "native" image to look like.
 */
function valueNoise(size: number, cell: number, rng: () => number): Float64Array {

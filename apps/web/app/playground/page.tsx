  ...
  return (
    <div className="shell pg">
      ...
      <p className="pg__lede">
        Drop an image and this page encodes it across every format and quality step the WebAssembly
        codecs offer, measures each candidate against your original with the same code CI runs, and
        plots the frontier worth spending bytes on. The image never leaves your machine: no upload,
        no server, no queue.
      </p>
      ...
      <p className="pg__footer">
        This is a demonstration, not a production path: in-browser encoding is slower than the CLI
        will be, and the page says so while it works. Definitions and known blind spots of every
        measurement are in the <Link href="/docs/metrics">metrics docs</Link>; the frontier line is
        the lower convex hull trick described in{' '}
